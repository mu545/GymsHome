  ...
  Widget build(BuildContext context) {
    ...
    return ClipRRect(
            ...
            // heart(Gym: Gym),
                              ...
                              SizedBox(width: 220,),Container( height: 40, width: 40, decoration: BoxDecoration(borderRadius: BorderRadius.circular(30), color: Colors.white),  child: IconButton(onPressed: (){}, icon: Icon(Icons.compare_arrows))) ],
                            ),Column(mainAxisAlignment:MainAxisAlignment.end,
                              children: [
